    ...
    <form id="form1" runat="server">
        ...
        <div id="projects" class="container">
            ...
            <div class="row my-4">
                ...
                <div class="col-lg-4 mx-auto my-auto">
                    <div id="mineCarousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-indicators">
                            <button type="button" data-bs-target="#mineCarousel" data-bs-slide-to="0" class="active"
                                aria-current="true" aria-label="Slide 1"></button>
                            <button type="button" data-bs-target="#mineCarousel" data-bs-slide-to="1"
                                aria-label="Slide 2"></button>
                            <button type="button" data-bs-target="#mineCarousel" data-bs-slide-to="2"
                                aria-label="Slide 3"></button>
                            <button type="button" data-bs-target="#mineCarousel" data-bs-slide-to="3"
                                aria-label="Slide 4"></button>
                        </div>
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="Content/Images/mine1.png" class="d-block w-100 mx-auto" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="Content/Images/mine2.png" class="d-block w-100 mx-auto" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="Content/Images/mine3.png" class="d-block w-100 mx-auto" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="Content/Images/mine4.png" class="d-block w-100 mx-auto" alt="...">
                            </div>
                        </div>
                        <button class="carousel-control-prev" type="button" data-bs-target="#mineCarousel"
                            data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#mineCarousel"
                            data-bs-slide="next">
                ...
                <div class="col-sm-6">
                    <h3 class="mb-0">Minesweeper</h3>
                    <label class="text-muted font-weight-light mt-0">
                        <small>CS2133 - Computer Science II</small>
                    </label>
                    ...
                    <p>This project drastically improved my understanding and skills in object oriented programming. I
                        also
                        learned MVC architecture and why it's necessary for a project like this one.</p>

                    <h4 class="mb-0">Keywords:</h4>
                    <p>Java, OOP, MVC, GUI, Java Swing, Java AWT</p>

                    <a target="_blank"
                        href="https://github.com/ParkerH98/OklahomaStateUniversity/tree/master/CS2133_ComputerScienceII/assignment_5_Parker_Hague"
                        class="text-dark glyphicon glyphicon-link" role="button" aria-pressed="true">
                    </a>
                    Source code
                </div>
            </div>
            ...
            <div class="row my-4">
                ...
                <div class="col-sm-6 mx-auto my-auto">
                    <div id="dataCarousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-indicators">
                            <button type="button" data-bs-target="#dataCarousel" data-bs-slide-to="0" class="active"
                                aria-current="true" aria-label="Slide 1"></button>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="Content/Images/data1.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="Content/Images/data2.png" class="d-block w-100" alt="...">
                            </div>
                ...
                <!-- Headings & Description -->
                <div class="col-sm-6">
                    <h3 class="mb-0">Data Converter</h3>
                    <label class="text-muted font-weight-light mt-0">
                    ...
                    <h4 class="mb-0">Keywords:</h4>
                    <p>JavaScript, HTML, CSS, Bootstrap, JQuery</p>

                    <a target="_blank" href="https://parkerhague.com/DataConverter"
                        class="text-dark glyphicon glyphicon-link" role="button" aria-pressed="true">
                    </a>
                    Website
                </div>
            ...
            <div class="row my-4">
                ...
                <div class="col-sm-4 mx-auto my-auto">
                    <div id="appCarousel" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="Content/Images/app1.jpeg" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="Content/Images/app2.jpeg" class="d-block w-100" alt="...">
                            </div>
                ...
                <div class="col-sm-6">
                    ...
                    <a target="_blank" href="https://github.com/ParkerH98/LowerHigher"
                        class="text-dark glyphicon glyphicon-link" role="button" aria-pressed="true">
                    </a>
                    Source code
                </div>
            ...
            <!-- Multiple Multithreaded Servers -->
            <div class="row my-4 ">
                <!-- Carousel -->
                <div class="col-sm-6 mx-auto my-auto">
                    <div id="serverCarousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-indicators">
                            <button type="button" data-bs-target="#serverCarousel" data-bs-slide-to="0" class="active"
                                aria-current="true" aria-label="Slide 1"></button>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="Content/Images/server1.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="Content/Images/server2.png" class="d-block w-100" alt="...">
                            </div>
                        </div>
                        <button class="carousel-control-prev" type="button" data-bs-target="#serverCarousel"
                            data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Previous</span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="#serverCarousel"
                            data-bs-slide="next">
                            <span class="carousel-control-next-icon" aria-hidden="true"></span>
                            <span class="visually-hidden">Next</span>
                        </button>
                ...
                <!-- Headings & Description -->
                <div class="col-sm-6">
                    <h3 class="mb-0">Multiple Multithreaded Servers</h3>
                    <label class="text-muted font-weight-light mt-0">
                        <small>CS4323 - Operating Systems Design & Implementation</small>
                    </label>
                    ...
                    <a target="_blank" href="https://github.com/ParkerH98/OS-Group_F"
                        class="text-dark glyphicon glyphicon-link" role="button" aria-pressed="true">
                    </a>
                    Source code
                </div>
            ...
            <div class="row my-4">
                ...
                <div class="col-sm-4 mx-auto my-auto">
                    <div id="jobCarousel" class="carousel slide" data-bs-ride="carousel">
                        <div class="carousel-indicators">
                            <button type="button" data-bs-target="#jobCarousel" data-bs-slide-to="0" class="active"
                                aria-current="true" aria-label="Slide 1"></button>
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="Content/Images/job1.png" class="d-block w-100" alt="...">
                            </div>
                            <div class="carousel-item">
                                <img src="Content/Images/job2.png" class="d-block w-100" alt="...">
                            </div>
                ...
                <!-- Headings & Description -->
                <div class="col-sm-6">
                    <h3 class="mb-0">Job Scheduling Priority Queue</h3>
                    <label class="text-muted font-weight-light">
                        <small>CS3353 - Data Structures & Algorithm Analysis</small>
                    </label>
                    ...
                    <h4 class="mb-0">Keywords:</h4>
                    <p>Java, Priority Queue, Max Heap, OOP</p>
            ...
            <!-- GitHub -->
            <div class="row my-5">
                <div class="col-sm-6 mx-0 my-auto">
                    <img src="parkerhague.com/Content/Images/github_repo.png" class="d-block img-fluid mx-auto"
                        alt="...">
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <h4 class="mb-0">Keywords:</h4>
                    <p>Java, C#, C, JavaScript, HTML, CSS, Python, Matlab, SQL</p>

                    <a target="_blank" href="https://github.com/ParkerH98" class="text-dark glyphicon glyphicon-link"
